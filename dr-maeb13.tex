...
% \author{Dr. Juan Julián Merelo Guervós, Dra. Maribel García Arenas,
% Pedro A. Castillo Valdivieso} \institute{Grupo GeNeura\\ Departamento
% de Arquitectura y Tecnología de Computadores\\ Universidad de
% Granada\\ \email{(jmerelo,maribel,pedro)@geneura.ugr.es} }
...
%TIÌTULO: Assessing speed-ups in commodity cloud storage services for distributed evolutionary algorithms TIPO DE PARTICIPACIOÌN: Oral
%CONGRESO: 2011 IEEE Congress on Evolutionary Computation
%PUBLICACIOÌN: isbn 978-1-4244-7833-0/11 pp.304-311. 2011

%AUTORES: M. GarciÌa-Arenas, J.J. Merelo, Pedro A. Castillo, J.L.J. Laredo, G. Romero and Antonio Miguel Mora 
%TIÌTULO: Using free cloud storage services for distributed evolutionary algorithms
%CONGRESO: 13th Annual Genetic and Evolutionary Computation Conference, GECCO 2011
%PUBLICACIOÌN: Proceedings, Dublin, Ireland, July 12-16, 2011. Natalio Krasnogor and Pier Luca Lanzi, Editors. ACM. pages 1603-1610. isbn 978-1-4503-0557-0. 2011

%AUTORES: Maribel Garcia-Arenas, Pedro Castillo Valdivieso, Gustavo Romero Lopez and Juan Julian Merelo Guervos 
%TIÌTULO: Cloud-based Evolutionary Parallel Computation using low cost storage services
%PUBLICACIOÌN: IEEE First International Symposium on Network Cloud Computing and Applications. isbn: 978-0-7695-4550- 9/11. pp.56-61. 2011. DOI 10.1109/NCCA.2011.16. 2011
...
son una representaci\'on inform\'atica de los par\'ametros necesarios para
resolverlo; por ejemplo, resolver el recorrido del llamado viajante de comercio (Travel Salesman Problem
\cite{DBLP:conf/iwann/MoraMCAGLR11} implicar\'ia
...
simplemente dividiendo la poblaci\'on en grupos denominados {\em islas}\cite{DBLP:conf/3pgcic/GuervosMFEL12} y creando  
% -pedro-una cita aqu\'i
alg\'un mecanismo de intercambio de individuos entre ellas.
...
algoritmos evolutivos teniendo una variedad de herramientas ya desarrolladas \cite{perl-ea}.
...
%as\'i como el proyecto 83 (CANUBE) concedido por el CEI-BioTIC UGR
